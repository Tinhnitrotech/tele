<div class="fade modal modal-confirm-post" id="modal_confirm_change_status_full">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                   <p>{{ trans('common.change_status_place_dashboard') }}</p>
                </div>
            </div>
            <!-- Modal footer -->
            <form id="change_status_full" method="POST">
                @csrf
                @method('POST')
