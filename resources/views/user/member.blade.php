@section('title', trans('user_search.title_search')." - ".getPlaceName()." - ".getSystemName())
@extends('common.layouts.user.main')
@push('scripts')
    <script src="{{ asset('js/validate/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('js/user/search_member.js') }}" type="text/javascript"></script>
    <script>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h1 class="text-center page-content p-3 font-weight-bold size-48">{{ trans('user_register.user_checkin') }}</h1>
                                        </div>
                                        <div class="col-sm-6 text-right">
                                            <a class="text-white" href="{{ routeByPlaceId('userCheckout') }}">
                                                <button type="button" class="btn btn-user-register btn-secondary waves-effect waves-light btn-radius mr-1 m-w-2">
                                                    {{ trans('user_register.member_exit') }}
                                                </button>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-4">
                                    <h3 class="text-center page-content p-3 font-weight-bold size-32">{{ trans('user_register.checkin_first_times') }}</h3>
                                </div>
                                <div class="col-12 col-sm-8">
                                    <a class="text-white" href="{{ routeByPlaceId('user.register') }}">
                                        <button type="button" class="btn btn-primary waves-effect waves-light custom-button">
                                            {{ trans('user_register.sing_up') }}
                                        </button>
                                    </a>
                                </div>
                            </div>
                            ...
                            <form action="javascript:void(0);" method="POST" id="memberRegisterForm">
                                ...
                                <div class="row text-center">
                                    <div class="col-12 col-sm-4">
                                        <h3 class="text-left page-title p-3 font-weight-bold size-32">{{ trans('user_register.sing_up_other') }}</h3>
                                        <div class="col-12">
                        ...
                        <div class="row mb-4 size-28">
                            <div class="col-12">
                                <div class="row justify-content-center dataTables_wrapper">
                                    ...
                                    <div class="col-sm-12">
                                        <form action="{{ routeByPlaceId('userCheckin') }}" method="post">
                                            @csrf
                                            <input hidden name="family_id" id="family_id" value="">
                                            <div class="form-group row">
                                                <div class="col-12 text-center">
                                                    <button type="submit" class="btn btn-lg btn-primary btn-rounded my-2 px-5 custom-button m-w-8">{{ trans('user_register.checkin_place') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
