...
const folder = {
    src: "public/template_admin/", // source files
    dist: "public/dist_admin/html", // build files
    dist_assets: "public/dist_admin/assets/", //build assets files
    src_scss: "public/scss/",
    dist_css: "public/dist_css/",
};
...
// mix all scss
function mixFileScss() {
    gulp
        .src([folder.src_scss + "*.scss"])
        .pipe(sourcemaps.init())
        .pipe(sass()) // scss to css
        .pipe(
            autoprefixer({
        ...
        .pipe(sourcemaps.write("./")) // source maps for icons.css
